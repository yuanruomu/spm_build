define("arale-dialog/1.4.1/dialog-debug", ["jquery", "arale-overlay/1.2.0/overlay-debug", "position/1.1.0/position-debug", "arale-iframe-shim/1.1.0/iframeshim-debug", "arale-widget/1.2.0/widget-debug", "arale-base/1.2.0/base-debug", "arale-class/1.2.0/class-debug", "arale-events/1.2.0/events-debug", "arale-templatable/0.10.0/templatable-debug", "handlebars/1.3.0/handlebars-debug", "handlebars-runtime/1.3.0/handlebars.runtime-debug"], function(require, exports, module) {
  var $ = require('jquery'),
    Overlay = require("arale-overlay/1.2.0/overlay-debug"),
    mask = Overlay.Mask,
    Events = require("arale-events/1.2.0/events-debug"),
    Templatable = require("arale-templatable/0.10.0/templatable-debug");
  // Dialog
  // ---
  ...
  var Dialog = Overlay.extend({
    ...
    attrs: {
      // 模板
      template: require("arale-dialog/1.4.1/dialog-debug.handlebars"),
      // 对话框触发点
      trigger: {
        value: null,
        getter: function(val) {
    ...
    _hideMask: function() {
      ...
      if (mask._dialogs && mask._dialogs[mask._dialogs.length - 1] === this) {
        mask._dialogs.pop();
      }
  ...
  var template = require("arale-dialog/1.4.1/confirmbox-debug.handlebars");
  ...
  module.exports.ConfirmBox = ConfirmBox;
  module.exports.outerBoxClass = "arale-dialog-1_4_1";
});
define("arale-dialog/1.4.1/dialog-debug.handlebars", ["handlebars-runtime/1.3.0/handlebars.runtime-debug"], function(require, exports, module) {
...
define("arale-dialog/1.4.1/confirmbox-debug.handlebars", ["handlebars-runtime/1.3.0/handlebars.runtime-debug"], function(require, exports, module) {
  var Handlebars = require("handlebars-runtime/1.3.0/handlebars.runtime-debug")["default"];
  module.exports = Handlebars.template(function(Handlebars, depth0, helpers, partials, data) {
    this.compilerInfo = [4, '>= 1.0.0'];
    helpers = this.merge(helpers, Handlebars.helpers);
    ...
    function program3(depth0, data) {
      ...
      stack1 = helpers['if'].call(depth0, (depth0 && depth0.confirmTpl), {
        hash: {},
        inverse: self.noop,
      ...
      buffer += "\n        ";
      stack1 = helpers['if'].call(depth0, (depth0 && depth0.cancelTpl), {
        hash: {},
        inverse: self.noop,
    ...
    function program4(depth0, data) {
      ...
      if (helper = helpers.confirmTpl) {
        stack1 = helper.call(depth0, {
          hash: {},
          data: data
        });
      } else {
        helper = (depth0 && depth0.confirmTpl);
        stack1 = typeof helper === functionType ? helper.call(depth0, {
          hash: {},
          data: data
        }) : helper;
    ...
    function program6(depth0, data) {
      ...
      if (helper = helpers.cancelTpl) {
        stack1 = helper.call(depth0, {
          hash: {},
          data: data
        });
      } else {
        helper = (depth0 && depth0.cancelTpl);
        stack1 = typeof helper === functionType ? helper.call(depth0, {
          hash: {},
          data: data
        }) : helper;
    ...
    buffer += "</div>\n    ";
    stack1 = helpers['if'].call(depth0, (depth0 && depth0.hasFoot), {
      hash: {},
      inverse: self.noop,
