define("arale-iframe-shim/1.1.0/iframeshim-debug", ["jquery", "position/1.1.0/position-debug"], function(require, exports, module) {
  var $ = require('jquery');
  var Position = require("position/1.1.0/position-debug");
